...
package.path = package.path .. ";" .. home_dir .. "/.local/lib/python2.7/site-packages/powerline/bindings/awesome/?.lua"
require("powerline")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "social", "web", "dev" }, s, { layouts[3], layouts[4], layouts[4] })
end
-- }}}
...
--'<span background="#4B3B51" font="Inconsolata 11"><span font="Inconsolata 11" color="#EEEEEE"> Vol:$1 </span></span>', 0.3, "-D pulse Master")
...
awful.util.spawn("sogou-qimpanel")
