...
-- {{{ Tags
tags = {
  names  = { "dev", "social", "web", "vbox" },
  layout = { layouts[4], layouts[1], layouts[4], layouts[4]
}}
...
globalkeys = awful.util.table.join(
    -- {{{ Applications
    awful.key({ modkey }, "Return", function () exec("gnome-terminal") end),
    awful.key({ "Ctrl", "Shift" }, "f", function () exec("firefox") end),
    -- }}}
